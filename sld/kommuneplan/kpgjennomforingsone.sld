...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
   ...
   <NamedLayer>
      <se:Name>kpgjennomforingsone</se:Name>
      <UserStyle>
         <se:Name>KpGjennomføringSone</se:Name>
         <se:FeatureTypeStyle>
            <se:Rule>
               <se:Name>KpGjennomføringSone</se:Name>
               ...
               <se:PolygonSymbolizer>
                  <se:Fill>
                     <se:GraphicFill>
                        <se:Graphic>
                           <se:ExternalGraphic>
                              <se:OnlineResource xlink:type="simple" xlink:href="/workspaces/kommuneplaner/styles/symbols/hatch-135-thin-black.svg" />
