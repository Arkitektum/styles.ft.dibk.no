...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
   ...
   <NamedLayer>
      <se:Name>rpbestemmelseomrade</se:Name>
      <UserStyle>
         <se:Name>RpBestemmelseOmråde</se:Name>
         <se:FeatureTypeStyle>
            <se:Rule>
               <se:Name>RpBestemmelseOmråde</se:Name>
			   <se:LineSymbolizer>
               ...
               <se:PolygonSymbolizer>
                  <se:Fill>
                     <se:GraphicFill>
                        <se:Graphic>
                           <se:ExternalGraphic>
                              <se:OnlineResource xlink:type="simple" xlink:href="${REGULERINGSPLAN_STYLES_PATH}/symbols/bestemmelseomrade.svg" />
