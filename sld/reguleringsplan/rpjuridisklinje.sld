                                ...
                                <se:Graphic>
                                    <se:ExternalGraphic>
                                        <se:OnlineResource xlink:type="simple"
                                            xlink:href="${BASE_PATH}/symbols/juridisk-linje-1204.png" />
                        ...
                        <se:Stroke>
                            <se:GraphicStroke>
                                <se:Graphic>
                                    <se:ExternalGraphic>
                                        <se:OnlineResource
                                            xlink:href="${BASE_PATH}/symbols/juridisk-linje-1227.svg"
                                            xlink:type="simple" />
                        ...
                        <se:Stroke>
                            <se:GraphicStroke>
                                <se:Graphic>
                                    <se:ExternalGraphic>
                                        <se:OnlineResource xlink:type="simple"
                                            xlink:href="${BASE_PATH}/symbols/svart-halv-linje.svg" />
                                        <se:Format>image/svg+xml</se:Format>
                                    </se:ExternalGraphic>
                                    <se:Size>18</se:Size>
                                    <se:Rotation>
                        ...
                        <se:Stroke>
                            <se:GraphicStroke>
                                <se:Graphic>
                                    <se:ExternalGraphic>
                                        <se:OnlineResource xlink:type="simple"
                                            xlink:href="${BASE_PATH}/symbols/juridisk-linje-1235.png" />
                                        <se:Format>image/png</se:Format>
                                    </se:ExternalGraphic>
                                    <se:Size>14</se:Size>
                                </se:Graphic>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        ...
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-linje-1259.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>12</se:Size>
                            <se:Rotation>
