                        ...
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1231.svg" />
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1241.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>28</se:Size>
                            <se:Rotation>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1242.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>38</se:Size>
                            <se:Rotation>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1243.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>32</se:Size>
                            <se:Rotation>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1244.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>32</se:Size>
                            <se:Rotation>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1251.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>18</se:Size>
                            <se:Rotation>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1253.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>18</se:Size>
                            <se:Rotation>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1271.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>37</se:Size>
                        </se:Graphic>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1272.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>25</se:Size>
                        </se:Graphic>
                ...
                <se:Rule>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:type="simple"
                                    xlink:href="${BASE_PATH}/symbols/juridisk-punkt-1273.svg" />
                                <se:Format>image/svg+xml</se:Format>
                            </se:ExternalGraphic>
                            <se:Size>16</se:Size>
                            <se:Rotation>
